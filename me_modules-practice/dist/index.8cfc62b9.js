...
var _shoppingCartJs = require("./shoppingCart.js"); // 237 23
...
_shoppingCartJs.addToCart("bread", 8); // 9 bread added to cart
console.log(_shoppingCartJs.totalPrice, _shoppingCartJs.tq);
(0, _shoppingCartJsDefault.default)("pizza", 12); // 12 pizza added to cart
...
const stateClone = (0, _lodashEs.cloneDeep)(state);
...
console.log((0, _shoppingCartJs.cart).find((el)=>el.quantity >= 7));

},{"./shoppingCart.js":"l6bJl","lodash-es":"bXNwz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","core-js/modules/web.immediate.js":"49tUX"}],"l6bJl":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"../internals/export":"dIGt4","../internals/global":"i8HOC","../internals/task":"7jDg7"}]},["2mNKm","6rimH"], "6rimH", "parcelRequire96d8")
