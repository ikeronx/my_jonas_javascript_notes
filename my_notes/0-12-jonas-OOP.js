...
class UserCl {
        ...
        // ❗️❗️ important when set a property that already exist (this.fullname)... make sure to use the pattern that also get the property again after setting it
        // 📌 SETTERS
        set fullName(name) {
...
// ❗️❗️ please note that static methods are not available on the instances only on the class/constructor itself
...
// step 2️⃣: create the object that will inherit from the prototype
const johnProto = Object.create(PersonProto);
// step 3️⃣: set the properties and methods of the object
...
// step 2️⃣: create the child constructor function
...
// step 3️⃣: linking prototypes: inherit the prototype properties (methods) [calcAge()] from the parent constructor ... - how link two constructor functions together
StudentChildConstructor.prototype = Object.create(PersonParentConstructor.prototype);

// step 4️⃣: set the child constructor back to the child constructor function prototype (methods) [calcAge()] from the parent constructor (Student) [.__proto__]
StudentChildConstructor.prototype.constructor = StudentChildConstructor;

// step 5️⃣: create the child constructor prototype properties (methods)
...
// step 6️⃣: create an instance of the child constructor function
...
// STEP 2️⃣: create the child class
class StudentChildClass extends PersonParentClass {
        constructor(firstName, birthYear, major) {
                ...
                // ❗️❗️ this always needs to happen first
...
// STEP 3️⃣: create an instance of the child class
...
// step 1️⃣: create the parent object that will be the prototype of the child class
const PersonProtoo = {
        calcAge() {
                console.log(new Date().getFullYear() - this.birthYear);
        },
...
// step 2️⃣: create the child object that will inherit from the prototype
const StudentProto = Object.create(PersonProtoo);

// step 3️⃣: set the properties and methods of the parent object to the child object
...
// step 4️⃣: create an instance of the child object
...
class Account3 {
        // ❗️❗️ please note that fields are supposed to be outside the constructor
        // ❗️ these fields are available on the instances themselves and not the prototype of the class
        ...
        requestLoan(val) {
                if (this._approveLoan(val)) {
                        ...
                        return this; // return this to able to chain methods
                }
        }
