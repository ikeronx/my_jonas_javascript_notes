...
// 👷🏽‍♂️🛠 how to can loop through a set
...
// 👷🏽‍♂️🛠  how to get a value from a map
...
// 👷🏽‍♂️🛠 how to use arrays as map keys
...
// 👷🏽‍♂️🛠 how to loop through a map
// for (const [key, value] of restaurantMap) {
//         console.log(`${key} : ${value}`);
// }

console.log('-----MAPS: Iteration-----');
// 👷🏽‍♂️🛠 how to create a new map without using the set() method
...
// 🤔🌍 Real World Example:
// 👷🏽‍♂️🛠 how loop through a map array
// quiz app
...
// 👷🏽‍♂️🛠 how to get the answer from the user using prompt
...
// 👷🏽‍♂️🛠 how to convert map back to array
...
// 👷🏽‍♂️🛠 how to covert objects to MAPS
const openingHours = {
        thu: {
                open: 12,
                close: 22,
