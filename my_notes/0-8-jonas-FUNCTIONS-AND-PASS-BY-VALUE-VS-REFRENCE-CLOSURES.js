...
// step 1️⃣. we can take lufthansa.book fn reference and store it in a new variole since javascript has first call functions:
...
// ❗️❗️ this does not work:
// ❗️ book(23, 'Sarah Williams') // <-- !! this wont work cause the 'this' keyword points points to a regular function call which the arguments equals to undefined... since the book variable is in the global name space and not a function
...
// 🌟 better way... instead of using apply method use the call method:
...
lufthansa.buyPlane = function () {
        // ... step 2️⃣. ❗️❗️👆🏾 make sure the function is not an arrow function when you use the bind() method to call the function in the addeventlistener below
        console.log(this);
        this.planes++;
...
// 📌 Binding with Partial Applications
