...
// 👷🏽‍♂️🛠 how to loop through the menu array using for of loop
for (const item of menu) console.log(item);

// 👷🏽‍♂️🛠 how to find array indexes using for of loop
for (const item of menu.entries()) {
        console.log(`Menu Item ${item[0] + 1}: ${item[1]}`);
}

// 👷🏽‍♂️🛠 how to destructure the array using for of loop
...
// 👷🏽‍♂️🛠 how to loop through objects using for of loop
// 1. 👷🏽‍♂️🛠 how to get the object PROPERTIES/KEYS use the Object.keys() method
...
// 2. 👷🏽‍♂️🛠  how to get the object VALUES use the Object.values() method
...
// 3. 👷🏽‍♂️🛠 how to get the object ENTRIES (both properties/keys and values) use the Object.entries() method
...
// 👷🏽‍♂️🛠 how to add a object literal inside another object literal by using ES6 enhanced object literals
// ... add the openingHours object to the restaurant
const openingHours = {
        [weekdays[4]]: {
                open: '9:00am',
                close: '5:00pm',
...
// 👷🏽‍♂️🛠  how to compute properties names dynamically
